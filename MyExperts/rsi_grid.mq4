...
ENTRYSIGNAL entrySignal() {
   ...
   if ((rsiPrev > rsiHighThreshold || rsiBefore > rsiHighThreshold) && rsi < rsiHighThreshold) signal = ENTRY_SHORT;
   if ((rsiPrev < rsiLowThreshold || rsiBefore < rsiLowThreshold) && rsi > rsiLowThreshold)   signal = ENTRY_LONG;
